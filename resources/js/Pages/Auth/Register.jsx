...
export default function Register() {
    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <Head title="Регистрация - StudyPro" />
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-3xl font-bold text-blue-900">
                        Присоединяйтесь к StudyPro
                    </h2>
                    <p className="mt-2 text-blue-700">
                        Начните учиться с удовольствием
                    </p>
                </div>

                <form onSubmit={submit} className="mt-8 space-y-6 bg-white p-8 rounded-2xl shadow-lg">
                    <div>
                        <InputLabel htmlFor="name" value="Имя" className="text-blue-900 font-medium" />
                        <TextInput
                            id="name"
                            name="name"
                            value={data.name}
